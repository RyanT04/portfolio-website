...
const projects = [
  {
    id: 1,
    title: "TradeGo",
    description: "Backend-focused trading simulator engineered for performance — built to benchmark how far a Go order-matching engine can push latency below a traditional Node.js stack. The architectural counterpart to TradeX. Originally deployed on AWS ECS Fargate; now self-hosted on a DigitalOcean Droplet via GitHub Student Developer Pack credits, with Nginx reverse-proxying HTTPS traffic to a containerized Go backend and PostgreSQL instance.",
    period: "Oct 2025 - May 2026",
    icon: ChartCandlestick,
    color: "from-[oklch(0.85_0.18_85)] to-[oklch(0.75_0.15_75)]",
    technologies: ["Go", "PostgreSQL", "Docker", "Nginx", "DigitalOcean", "Let's Encrypt"],
    highlights: [
      { metric: "60-75%", label: "Latency Reduction" },
      { metric: "Go", label: "Order Matching Engine" },
      { metric: "HTTPS", label: "Self-Hosted Deployment" },
    ],
    features: [
      "Go order-matching engine achieving 60–75% latency reduction over Node.js",
      "Self-managed Docker deployment on a DigitalOcean Droplet",
      "Nginx reverse proxy with free auto-renewing HTTPS via Let's Encrypt",
      "PostgreSQL running in a dedicated container with persistent volume storage",
      "Real-time profiling of latency and CPU bottlenecks",
    ],
    links: {
      github: "https://github.com/RyanT04/TradeGo",
      live: "https://trade-go.tech",
    },
  },
  {
    id: 2,
